       ...
       <hr style="margin-bottom: 50px">
     	<table style="width: 80%; margin-left: 10%; margin-top:100px" >
	        ...
	        <tr>
				...
				<th style="width: 65%;">${prodVO.prodNm}</th>
	        </tr>
	        <tr>
		        <th style="width: 35%;">상품 사진</th>
				<th style="width: 65%;"><img src="/upload/${prodVO.prodImgNm}" width="150px" class="a"></th>
	        </tr>
	        <tr>
		        <th style="width: 35%;">판매가</th>
				<th style="width: 65%;">${prodVO.prodPrice}</th>
	        </tr>
	        <tr>
		        <th style="width: 35%;">상품 수량</th>
				<th style="width: 65%;">${prodVO.prodQty}</th>
	        </tr>
	        <tr>
		        <th style="width: 35%;">판매단위</th>
				<th style="width: 65%;">${prodVO.prodUnit}</th>
	        </tr>
	         <tr>
		        <th style="width: 35%;">중량/용량</th>
				<th style="width: 65%;">${prodVO.prodVol}</th>
	        </tr>
       </table>
