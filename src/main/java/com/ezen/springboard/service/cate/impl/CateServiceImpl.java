...
import com.ezen.springboard.service.cate.CateService;
...
public class CateServiceImpl implements CateService{
	...
	public List<CateVO> getCateList(Map <String, String> paramMap) {
		return cateDAO.getCateList(paramMap);
	}
	...
	@Override
	//카테고리 수정
	public void updateCate(CateVO cateVO, List<ProdFileVO> ) {
		cateDAO.updateCate(cateVO);
		
	}
	@Override
	//카테고리 삭제
	public void deleteCate(int prodNo) {
